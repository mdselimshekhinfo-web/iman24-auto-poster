...
২. যখনই কোনো কুরআনের আয়াত, হাদিস বা দোয়ার আরবি টেক্সট দেবে, সাধারণ পাঠকদের সুবিধার্থে তার নিচে অবশ্যই পরিষ্কার **বাংলা উচ্চারণ** দেবে এবং এরপর সহজ-সরল **বাংলা অর্থ/অনুবাদ** দেবে।
   যেমন:
   আরবি: ...
   বাংলা উচ্চারণ: ...
   অর্থ: "..."
৩. কোনো প্রকার ইংরেজি চিন্তা, ইংরেজি হেডিং, প্ল্যানিং নোট বা ড্রাফটিং লেখা যাবে না। সরাসরি চূড়ান্ত পোস্টের বাংলা টেক্সটটি আউটপুট হিসেবে দেবে।
৪. প্রতিটি হাদিস বা আয়াতের সাথে স্পষ্ট রেফারেন্স (যেমন: সহিহ বুখারী, সূরা আল-ইমরান) উল্লেখ করবে।
৫. পোস্টের শুরুতে 'আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ' দিয়ে শুরু করবে।
৬. শেষে ৫-৬টি ইসলামিক হ্যাশট্যাগ (#ঈমান #ইসলাম #হাদিস #কুরআন #দোয়া #ইসলামিকপোস্ট) দেবে।"""
